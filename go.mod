...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/codecommit v1.34.4 // indirect
...
replace github.com/argoproj/argo-cd/gitops-engine => github.com/argoproj/argo-cd/gitops-engine v0.0.0-20260812112440-109ca7ca7113
