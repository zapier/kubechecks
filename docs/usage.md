...
|`KUBECHECKS_SKILL_AGENT_ADDRS`|gRPC addresses of A2A skill agents to connect at startup, e.g. knowledge-engine-server.knowledge-engine:50051. Repeatable.|`[]`|
|`KUBECHECKS_SKILL_AGENT_TIMEOUT`|Per-call timeout for A2A skill agent queries.|`3s`|
